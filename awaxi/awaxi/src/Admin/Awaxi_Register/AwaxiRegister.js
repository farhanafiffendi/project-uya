...
export default function Admin() {
  ...
  useEffect(() => {
    fetch("https://awaxii.pocari.id/dev/web_tools?key=all")
      .then((res) => res.json())
      .then((json) => {
        setData({
          result: json,
  ...
  const handleChangeHapusPatient = (e, id) => {
    ...
    axios
      .post(`https://awaxii.pocari.id/dev/web_tools/delete/${id}`) // <-- remove ;
      .then((res) => {
                          ...
                          .map((row, index) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <TableCell align="center">
                                  {row.action}
                                  <Link to={`/EditRegister/${row.key}`}>
                                    <CreateRoundedIcon />
                                  </Link>
                                  <Button 
                                  style={{marginTop: "-8%", color: "#c62828"}}
                                    onClick={(e) => {
