...
export default function AwaxiUser() {
  ...
  useEffect(() => {
    fetch("	https://awaxii.pocari.id/dev/web_user?key=all")
      .then((res) => res.json())
      .then((json) => {
        setData({
          result: json,
  ...
  const handleChangeHapusPatient = (e, id) => {
    ...
    axios
    .post(`https://awaxii.pocari.id/dev/web_user/delete/${id}`) // <-- remove ;
    .then((res) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <TableCell align="left">
                                  ...
                                  <Link to={`/editAwaxiUser/${row.key}`}>
                                    <CreateRoundedIcon />
                                  </Link>
                                  <Button
                                  style={{marginTop: "-13%", color: "#c62828"}}
                                    onClick={(e) => {
