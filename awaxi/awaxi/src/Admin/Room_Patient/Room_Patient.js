...
const EnhancedTableToolbar = (props) => {
  ...
  function handleChangeAddRoomPatient(e) {
    e.preventDefault();
    history("/addRoomPatient");
  }
  ...
  return (
    ...
    >
      ...
      <div>
        <Button onClick={handleChangeAddRoomPatient}>
...
export default function Admin() {
 ...
 console.log(key);
  ...
  useEffect(() => {
    fetch("https://awaxii.pocari.id/dev/web_setting_room?key=all")
      .then((res) => res.json())
      .then((json) => {
        setData({
          result: json,
  ...
  const handleChangeHapusPatient = (e, id) => {
    ...
    axios
      .post(`https://awaxii.pocari.id/dev/web_setting_room/delete/${id}`) // <-- remove ;
      .then((res) => {
        // const users = res.data.data;
        // this.setState({ users });
        console.log("Hapus Room Patient");
        // console.log(users);
        setOpen(true);
                            ...
                            return (
                              ...
                              >
                                ...
                                <TableCell align="center">
                                  <Link to={`/editRoomPatient/${row.key}`}>
                                    <CreateRoundedIcon />
                                  </Link>
                                  {/* <Button >
                                  <CreateRoundedIcon />
